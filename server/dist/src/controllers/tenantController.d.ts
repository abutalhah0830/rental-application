...
export declare const getCurrentResidences: (req: Request, res: Response) => Promise<void>;
export declare const addFavoriteProperty: (req: Request, res: Response) => Promise<void>;
export declare const removeFavoriteProperty: (req: Request, res: Response) => Promise<void>;
