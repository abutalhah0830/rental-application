import { FiltersState, initialState, setFilters } from '@/app/asset-download/asset-download/client/state'
    ...
    const handleLocationSearch = async () => {
        try {
            const response = await fetch(
                `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(localFilters.location
                )}.json?access_token=${
