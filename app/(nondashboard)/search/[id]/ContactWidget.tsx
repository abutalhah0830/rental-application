import { useGetAuthUserQuery } from '@/app/asset-download/asset-download/client/state/api'
...
const ContactWidget = ({ onOpenModal} : ContactWidgetProps) => {
  ...
  return (
    <div className='bg-white border border-primary-200 rounded-2xl p-7 h-fit min-w-[300px]'>
        {/* Contact Property */}
        <div className="flex items-center gap-5 mb-4border border-primary-200 p-4 rounded-xl">
          ...
          >
            ...
            <div className='text-sm'>
                ...
                <div className='text-primary-600'>
                    Open by appointemnt on Monday - Sunday
                </div>
            </div>
    </div>
  )
