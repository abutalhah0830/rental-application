...
import { useGetAuthUserQuery, useGetManagerPropertiesQuery, useGetPaymentsQuery, useGetPropertiesQuery, useGetPropertyLeasesQuery, useGetPropertyQuery} from '@/app/asset-download/asset-download/client/state/api'
     ...
     <div className='w-full space-y-6'>
        <div className='mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6'>
            <div className='flex justify-between items-center mb-4'>
                ...
                <div>
                    <button className={`bg-white border border-gray-300 text-gray-700 py-2 
                    ...
                    <TableBody>
                        {leases?.map((lease) => (
                            <TableRow key={lease.id} className='h-24'>
                                ...
                                <TableCell>
                                    <button
                                      className={`border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center
                                        font-semibold hover:bg-primary-700 hover:text-primary-50`}
                                      >
