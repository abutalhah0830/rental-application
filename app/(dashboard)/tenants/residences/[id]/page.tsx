"use client"
import { useGetAuthUserQuery, useGetLeasesQuery, useGetPaymentsQuery, useGetPropertyQuery } from '@/app/asset-download/asset-download/client/state/api'
import { Lease, Payment, Property } from '@/app/prismaTypes'
...
const PaymentMethod = () => {
    return (
        <div className='bg-white rounded-xl shadow-xl overflow-hidden p-6 mt-10 md:mt-0 flex-1'>
            ...
            <div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='xl:flex'>
                     ...
                     <div className='border-[0.5px] border-primary-300 h-4' />
                    <div className='xl:flex'>
                        <div className='text-gray-500 mr-2'>Next Payment Date: </div>
                        <div className='font-semibold'>
                            {new Date(currentLease.endDate).toLocaleDateString()}
                        </div>
                    </div>
